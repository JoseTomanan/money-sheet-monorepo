...
description: Maintain money-sheet-monorepo documentation as an accurate decision and operating record: README/setup guidance, CONTEXT.md glossary, ADRs, AGENTS.md, agent skills, and issue/PR text. Use when documentation must change with implementation, a contract or workflow needs recording, or existing docs conflict with repository evidence.
---
...
| Repository structure, commands, and agent constraints | `AGENTS.md` |
| Agent task procedure or specialized reference | `.Codex/skills/<name>/SKILL.md` and optional `REFERENCE.md` |
...
4. Search for contradictory descriptions across `README.md`, `CONTEXT.md`, `AGENTS.md`, ADRs, and skills; reconcile material conflicts in the same change.
...
- Documentation ownership: `AGENTS.md`, `CONTEXT.md`, and `docs/adr/`.
