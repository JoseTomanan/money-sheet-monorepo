...
import type { Entry, AddEntryPayload, AddEntryRequest, AddEntriesPayload, UpdateEntryPatch, CategoryMap, Config, ApiErrorEnvelope, StatsData } from './types';
import type {
  EntryData,
  AddEntryPayload as ClaspAddEntryPayload,
  AddEntryRequest as ClaspAddEntryRequest,
...
type __AssertAddEntryRequest = __Expect<__Equal<AddEntryRequest, ClaspAddEntryRequest>>;
