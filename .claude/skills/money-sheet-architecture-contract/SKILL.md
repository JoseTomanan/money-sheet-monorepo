...
deleteEntry. (Root CLAUDE.md's table drifts from this — trust dispatch.ts.)
...
| Hardcoded GAS deploymentId in CI (and a *different* one in `.claude/settings.json:22`) | `.github/workflows/gas-deploy.yml:31` |
